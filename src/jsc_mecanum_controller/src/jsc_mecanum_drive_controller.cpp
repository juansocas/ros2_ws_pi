...
#include "jsc_mecanum_controller/jsc_mecanum_drive_controller.hpp"

PLUGINLIB_EXPORT_CLASS(
    jsc::mecanumbot::controller::MecanumbotDriveController,
    controller_interface::ControllerInterface
)

using namespace jsc::mecanumbot::controller;
...
controller_interface::return_type MecanumbotDriveController::update(const rclcpp::Time & time, const rclcpp::Duration & period)
{
    ...
    // Establecer las velocidades de las ruedas escaladas
