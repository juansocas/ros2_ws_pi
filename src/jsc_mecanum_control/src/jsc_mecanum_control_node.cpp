...
int main(int argc, char * argv[])
{
    ...
    controller_manager_node->load_controller("jsc_mecanum_drive_controller", "jsc_mecanum_controller/MecanumbotDriveController");
    controller_manager_node->configure_controller("joint_state_broadcaster");
    controller_manager_node->configure_controller("jsc_mecanum_drive_controller");

    start_controllers.push_back("joint_state_broadcaster");
    start_controllers.push_back("jsc_mecanum_drive_controller");
